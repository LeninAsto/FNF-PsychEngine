...
class MainMenuState extends MusicBeatState
{
	...
	public static var psychEngineVersion:String = '1.0.4 (1.0.5)'; // This is also used for Discord RPC
    public static var plusEngineVersion:String = '1.0.5'; // Nothing interesting =)
