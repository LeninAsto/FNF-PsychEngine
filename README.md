...
To learn about new Advances variables for Modcharts, clic [here](https://github.com/LeninAsto/FNF-PlusEngine/blob/v0.4/docs/scripts/Document Origin Modchart.md)
